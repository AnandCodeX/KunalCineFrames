...
const Main = () => {
  ...
  return (
    <div id="Main" className="relative h-screen flex justify-center items-center overflow-hidden">
      {isVideoLoaded && (
        <iframe
      ...
      <div className="relative z-10 text-center text-white p-5">
        ...
        <p className="text-lg md:text-xl mb-8">
          KunalCineFrames Turning life’s fleeting moments into timeless memories
        </p>
